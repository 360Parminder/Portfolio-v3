  ...
  return (
    ...
    >
      <div
        ...
        style={{ color: "var(--line-stroke-accent)", bottom: "calc(100% + 6px)" }}
      >
      ...
      <div className={clsx('flex', 'flex-col', 'uppercase')}>
        ...
        <div className={clsx('flex', 'border-b', 'border-[var(--line-stroke)]')}>
          <div className={clsx('w-[60%]', 'p-2', 'border-r', 'border-[var(--line-stroke)]', 'flex', 'flex-col', 'justify-center')}>
            <span className={clsx('text-[8px]', 'opacity-70', 'text-[var(--line-stroke-accent)]')}>PROJECT TITLE</span>
          ...
          <div className={clsx('w-[40%]', 'flex', 'flex-col')}>
            <div className={clsx('flex-1', 'border-b', 'border-[var(--line-stroke)]', 'flex', 'items-center', 'px-2')}>
              <span className={clsx('text-[8px]', 'w-8', 'opacity-70', 'text-[var(--line-stroke-accent)]')}>SIZE</span>
              <span className={clsx('text-[10px]', 'text-[var(--foreground)]')}>WEB</span>
            </div>
            <div className={clsx('flex-1', 'flex', 'items-center', 'px-2')}>
              <span className={clsx('text-[8px]', 'w-8', 'opacity-70', 'text-[var(--line-stroke-accent)]')}>REV</span>
        ...
        <div className={clsx('flex', 'border-b', 'border-[var(--line-stroke)]')}>
          <div className={clsx('flex-1', 'border-r', 'border-[var(--line-stroke)]', 'flex', 'flex-col', 'p-1.5', 'px-2')}>
            <span className={clsx('text-[7px]', 'opacity-70', 'text-[var(--line-stroke-accent)]')}>DRAWN BY</span>
            <span className={clsx('text-[9px]', 'text-[var(--foreground)]')}>P. SINGH</span>
          </div>
          <div className={clsx('flex-1', 'border-r', 'border-[var(--line-stroke)]', 'flex', 'flex-col', 'p-1.5', 'px-2')}>
            <span className={clsx('text-[7px]', 'opacity-70', 'text-[var(--line-stroke-accent)]')}>DATE</span>
            <span className={clsx('text-[9px]', 'text-[var(--foreground)]')}>2026-07-20</span>
          </div>
          <div className={clsx('flex-1', 'flex', 'flex-col', 'p-1.5', 'px-2')}>
            <span className={clsx('text-[7px]', 'opacity-70', 'text-[var(--line-stroke-accent)]')}>SCALE</span>
        ...
        <div className="flex">
          <div className={clsx('flex-1', 'border-r', 'border-[var(--line-stroke)]', 'flex', 'flex-col', 'p-1.5', 'px-2')}>
            <span className={clsx('text-[7px]', 'opacity-70', 'text-[var(--line-stroke-accent)]')}>APPROVED BY</span>
            <span className={clsx('text-[9px]', 'text-[var(--foreground)]')}>CLIENT</span>
          </div>
          <div className={clsx('flex-1', 'border-r', 'border-[var(--line-stroke)]', 'flex', 'flex-col', 'p-1.5', 'px-2')}>
            <span className={clsx('text-[7px]', 'opacity-70', 'text-[var(--line-stroke-accent)]')}>STATUS</span>
            <span className={clsx('text-[9px]', 'text-[var(--foreground)]')}>PRODUCTION</span>
          </div>
          <div className={clsx('flex-1', 'flex', 'flex-col', 'p-1.5', 'px-2')}>
            <span className={clsx('text-[7px]', 'opacity-70', 'text-[var(--line-stroke-accent)]')}>SHEET</span>
